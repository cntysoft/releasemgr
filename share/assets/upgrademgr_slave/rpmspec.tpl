...
%build
/usr/local/bin/qbs -f ../SOURCES/%{name}.qbs profile:Qt5 project.resourcesInstallDir:share/upgrademgr_slave project.upgrademgrSlaveVersion:%{version} qbs.installRoot:%{installRoot} release
%files

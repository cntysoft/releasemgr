 ...
 * @var string 筑巢开放存储名称
 */
const RT_ZHUCHAO_OSS_IMG_BUCKET = ZHUCHAO_OSS_IMG_BUCKET_DEBUG;
/**
 * @var string 筑巢图片cdn地址
 */
const RT_ZHUCHAO_IMG_CDN_SERVER = ZHUCHAO_IMG_CDN_SERVER_DEBUG;
/**
 * @var string 是否为开发者模式
 */
 ...
 * @var string 部署类型
 */
const RT_DEPLOY_TYPE = DEPLOY_TYPE_PUBLIC_DEBUG;
#ifndef RELEASEMGR_TASK_FHZC_DIFFBUILD_GENERATE_DIFF_METAINFO_H
#define RELEASEMGR_TASK_FHZC_DIFFBUILD_GENERATE_DIFF_METAINFO_H
...
#endif // RELEASEMGR_TASK_FHZC_DIFFBUILD_GENERATE_DIFF_METAINFO_H

#ifndef RELEASEMGR_TASK_CLOUD_CONTROLLER_DIFF_BUILD_TASKS_H
#define RELEASEMGR_TASK_CLOUD_CONTROLLER_DIFF_BUILD_TASKS_H
...
#endif // RELEASEMGR_TASK_CLOUD_CONTROLLER_DIFF_BUILD_TASKS_H

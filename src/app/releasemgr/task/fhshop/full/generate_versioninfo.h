#ifndef RELEASEMGR_TASK_FHSHOP_FULLBUILD_GENERATE_VERSIONINFO_H
#define RELEASEMGR_TASK_FHSHOP_FULLBUILD_GENERATE_VERSIONINFO_H
...
#endif // RELEASEMGR_TASK_FHSHOP_FULLBUILD_GENERATE_VERSIONINFO_H

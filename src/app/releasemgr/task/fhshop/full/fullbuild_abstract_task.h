#ifndef RELEASEMGR_TASK_FHSHOP_FULLBUILD_FULLBUILD_ABSTRACT_TASK_H
#define RELEASEMGR_TASK_FHSHOP_FULLBUILD_FULLBUILD_ABSTRACT_TASK_H
...
#endif // RELEASEMGR_TASK_FHSHOP_FULLBUILD_FULLBUILD_ABSTRACT_TASK_H

#ifndef RELEASEMGR_TASK_UPGRADEMGR_SLAVE_RPM_BUILD_TASKS_H
#define RELEASEMGR_TASK_UPGRADEMGR_SLAVE_RPM_BUILD_TASKS_H
...
#endif // RELEASEMGR_TASK_UPGRADEMGR_SLAVE_RPM_BUILD_TASKS_H

#ifndef RELEASEMGR_TASK_RMMGR_RPM_RPMBUILD_ABSTRACT_TASK_H
#define RELEASEMGR_TASK_RMMGR_RPM_RPMBUILD_ABSTRACT_TASK_H
...
#endif // RELEASEMGR_TASK_RMMGR_RPM_RPMBUILD_ABSTRACT_TASK_H

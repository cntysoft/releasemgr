#ifndef RELEASEMGR_TASK_RMMGR_RPM_MAKE_PROJECT_STRUCTURE_H
#define RELEASEMGR_TASK_RMMGR_RPM_MAKE_PROJECT_STRUCTURE_H
...
#endif // RELEASEMGR_TASK_RMMGR_RPM_MAKE_PROJECT_STRUCTURE_H
